...
import { MiuRamenFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = MiuRamenFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new MiuRamenFactory(FACTORY_ADDRESS);
